...
四款游戏均支持：初中高三档难度、键盘 + 触屏操作、背景音乐、音效、全局静音和最高分记录（localStorage）。共用词库从 `paul-learn-english` 导入并去重，现有初级 597、中级 790、高级 942 个单词。音频来源与许可证见 [AUDIO-LICENSES.md](AUDIO-LICENSES.md)。

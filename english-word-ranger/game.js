...
function drawBossStatus() {
  ...
  ctx.fillStyle = '#e8daca'; ctx.font = '800 11px system-ui, sans-serif'; ctx.textAlign = 'left'; ctx.fillText(MISSION_LEVELS[Game.missionLevel].bossName + ' · 阶段 ' + boss.bossPhase, x + 12, y + 16);

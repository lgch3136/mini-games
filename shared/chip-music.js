...
(function () {
  ...
  SONGS['ranger-stage'] = (() => {
    ...
    return {
      tempo: 128,
      patterns: P,
      order: ['intro', 'a1', 'a2', 'b1', 'a1', 'a2', 'b1', 'a2', 'b1', 'a1', 'a2', 'b1', 'a1', 'a2'],  // 完整主题约53秒后循环
    };
  })();
  ...
  SONGS['ranger-boss'] = (() => {
    ...
    return { tempo: 140, patterns: P, order: ['v1', 'v2', 'v1', 'v2', 'v1', 'v2', 'v1', 'v2', 'v1', 'v2', 'v1', 'v2', 'v1', 'v2', 'v1', 'v2'] };  // ~55s
  })();
  ...
  SONGS['fighter-loop'] = {
    ...
    patterns: {
      a: {
        lead: ['E4', 'G4', 'A4', 'B4', 'A4', 'G4', 'E4', null, 'D4', 'E4', 'G4', 'A4', 'B4', null, 'A4', 'G4',
               'E5', 'D5', 'B4', 'A4', 'G4', 'A4', 'B4', null, 'D5', 'B4', 'A4', 'G4', 'E4', null, 'B4', null],
        harmony: ['B3', 'E4', 'E4', 'G4', 'E4', 'E4', 'B3', null, 'A3', 'B3', 'E4', 'E4', 'G4', null, 'E4', 'E4',
                  'B4', 'A4', 'G4', 'E4', 'D4', 'E4', 'G4', null, 'A4', 'G4', 'E4', 'D4', 'B3', null, 'G4', null],
        bass: ['E2', null, 'E3', 'E2', 'C2', null, 'C3', 'C2', 'D2', null, 'D3', 'D2', 'B1', null, 'B2', 'B1',
               'E2', null, 'E3', 'E2', 'G1', null, 'G2', 'G1', 'A1', null, 'A2', 'B1', 'E2', 'B2', 'E3', null],
        drums: ['K', '.', 'h', '.', 'S', '.', 'h', '.', 'K', '.', 'h', 'K', 'S', '.', 'h', '.',
                'K', '.', 'h', 'K', 'S', '.', 'h', '.', 'K', '.', 'S', '.', 'S', '.', 'h', 'o'],
      },
      b: {
        lead: ['B4', 'B4', 'D5', 'E5', 'G5', 'E5', 'D5', 'B4', 'A4', 'A4', 'C5', 'D5', 'E5', 'D5', 'C5', 'A4',
               'G4', 'B4', 'D5', 'G5', 'F#5', 'E5', 'D5', 'B4', 'C5', 'B4', 'A4', 'G4', 'E4', 'G4', 'B4', 'E5'],
        harmony: ['G4', 'G4', 'B4', 'B4', 'D5', 'B4', 'A4', 'G4', 'E4', 'E4', 'A4', 'A4', 'C5', 'A4', 'A4', 'E4',
                  'D4', 'G4', 'B4', 'D5', 'D5', 'B4', 'A4', 'G4', 'A4', 'G4', 'E4', 'D4', 'B3', 'E4', 'G4', 'B4'],
        bass: ['G2', null, 'G3', 'G2', 'E2', null, 'E3', 'E2', 'A1', null, 'A2', 'A1', 'C2', null, 'C3', 'C2',
               'G1', null, 'G2', 'G1', 'B1', null, 'B2', 'B1', 'C2', 'G2', 'A2', 'B2', 'E2', 'B2', 'E3', null],
        drums: ['K', '.', 'h', 'K', 'S', '.', 'h', '.', 'K', 'h', '.', 'K', 'S', '.', 'h', 'o',
                'K', '.', 'h', 'K', 'S', '.', 'h', 'h', 'K', '.', 'S', 'K', 'S', '.', 'h', 'o'],
      },
    },
    order: ['a', 'a', 'b', 'a', 'b', 'b', 'a', 'a', 'b', 'a', 'b', 'b', 'a', 'b'],
  };
